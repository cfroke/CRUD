...
<form action="<?php echo $CRUD["SELF"] ?>" method="post" name="album">
    ...
    <table class="form">
    <tr>
        <td><p class="Afield"> File:</p></td>
        <td><input class="Afield" type="text" name="Atitle" value="<?php echo $CRUD["Atitle"] ?>"> </td>
    </tr>
    <tr>
        <td><p class="Afield"> Program:</p></td>
        <td><input class="Afield" type="text" name="Aartist" value="<?php echo $CRUD["Aartist"] ?>"> </td>
    </tr>
    <tr>
        <td><p class="Afield"> Part # and Description:</p></td>
        <td><input class="Afield" type="blob" name="Alabel" value="<?php echo $CRUD["Alabel"] ?>"> </td>
    </tr>
    <tr class="released">
        <td><p class="Afield"> Created:</p></td>
        <td>
